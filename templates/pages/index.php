...
require_once 'lib/xmlToArrayParser.class.php';
include "config.php";
...
<body>
    ...
    <div id="wrapper">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <?php
                            $logoutURL = "https://cas.utc.fr/cas/logout?service=http://".$_SERVER['HTTP_HOST']."/picassoAdmin/pages";
                        ?>
                        <li><?php echo "<a href=\"".$logoutURL."\">" ?><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Dashboard | Tout ca &agrave; venir!</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
